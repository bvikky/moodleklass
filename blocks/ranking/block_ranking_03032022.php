...
class block_ranking extends block_base {
    ...
    public function get_content() {
		...
		$rankingtitle = '<h4 class="title">'. format_text("Course Ranking", FORMAT_HTML, array('filter' => true)) .'</h4>';
        $this->content->text = $rankingtitle.$rankingstables . $individualranking;
