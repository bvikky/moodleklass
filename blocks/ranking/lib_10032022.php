...
function block_ranking_print_students($rankinglastmonth, $rankinglastweek, $rankinggeral) {
	...
	echo"week points<pre>";
	print_r($tablelastweek);
	exit;
                ...
                <div>
                    <div id="semanal">
						<div class="ranking-user">
							<div class="userimage">'.$tablelastweek['user']['userimage'].'</div>
							<div class="row">
								<div class="col-md-4 user-details">
									<p class="rank-details">Position</p><p class="rank-details">'.$tablelastweek['user']['position'].'</p>
								</div>
								<div class="col-md-4 user-details">'.
									$tablelastweek['user']['username'].'
								</div>
								<div class="col-md-4 user-details">
									<p class="rank-details">Points</p><p class="rank-details">'.$tablelastweek['user']['userpoints'].'</p>
								</div>
							</div>
						</div>
                    ...
                    <div id="mensal">
						<div class="ranking-user">
							<div class="userimage">'.$tablelastmonth['user']['userimage'].'</div>
							<div class="row">
								<div class="col-md-4 user-details">
									<p class="rank-details">Position</p><p class="rank-details">'.$tablelastmonth['user']['position'].'</p>
								</div>
								<div class="col-md-4 user-details">'.
									$tablelastmonth['user']['username'].'
								</div>
								<div class="col-md-4 user-details">
									<p class="rank-details">Points</p><p class="rank-details">'.$tablelastmonth['user']['userpoints'].'</p>
								</div>
							</div>
						</div>
                    ...
                    <div id="geral">
						<div class="ranking-user">
							<div class="userimage">'.$tablegeral['user']['userimage'].'</div>
							<div class="row">
								<div class="col-md-4 user-details">
									<p class="rank-details">Position</p><p class="rank-details">'.$tablegeral['user']['position'].'</p>
								</div>
								<div class="col-md-4 user-details">'.
									$tablegeral['user']['username'].'
								</div>
								<div class="col-md-4 user-details">
									<p class="rank-details">Points</p><p class="rank-details">'.$tablegeral['user']['userpoints'].'</p>
								</div>
							</div>
						</div>
...
function block_ranking_print_individual_ranking() {
  ...
  /* $individualranking = array(
								'lastweekpoints'=>$lastweekpoints, 
								'lastmonthpoints'=>$lastmonthpoints,
...
function generate_table($data) {
	...
	/*echo"12323424gfihjofhodfjhuiofhjnj<pre>";
		print_r($data);
		exit;*/
